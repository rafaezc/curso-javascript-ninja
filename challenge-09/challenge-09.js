(function() {
  ...
  */
  > var subtraction = calculator(99, 1);
  > var multiplication = calculator(10, 5);
  > var division = calculator(2520, 5);
  > var module = calculator(2078, 7);
  ...
  */
  ...
  ... return x / y;
  ... })); //O resultado da divisão é: 504

  > console.log('O resultado do módulo é: ' + module(function(x, y) {
  ... return x % y;
  ... })); //O resultado do módulo é: 6
})();  
