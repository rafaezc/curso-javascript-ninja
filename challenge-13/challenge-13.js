(function() {
  ...
  */
  > var acme = ['dinamite', 'tnt', 'nitroglicerina', 'c4'];
  > console.log( 'O array em formato de string é:' );
  > console.log(acme.toString());
  ...
  */
  ...
  > var verificLetras = brasil.every(function (x) {
  ... return x.length > 7;
  ... });

  > console.log(verificLetras
  ... ? 'Sim, todos os estados tem mais de 7 letras!'
  ... : 'Nem todos os estados tem mais de 7 letras!');
  ...
  */
  ...
  > var verificCeara = brasil.some(function (x) {
  ... return x === 'Ceará';
  ... });

  > console.log(verificCeara
  ... ? 'Ceará foi incluído!'
  ... : 'Ceará não foi incluído');
  ...
  */
  > var map = newBrasil.forEach(function (x, i) {
  ... map.push({
  ..... id: x.id + 1,
  ..... estado: x.estado + ' pertence ao Brasil!',
  ..... })
  ... });
  ...
  */
  > var filter = map.filter(function (x, i) {
  ... return x.id % 2 === 0;
  ... });
