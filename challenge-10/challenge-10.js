(function() {
  ...
  */
  > opSignal = '-';
  var subtraction = calculator(opSignal);
  ...
  > opSignal = '*';
  var multiplication = calculator(opSignal);
  ...
  > opSignal = '/';
  var division = calculator(opSignal);
  ...
  > opSignal = '%';
  var module = calculator(opSignal);

  > if (module) {
  ... num1 = 250;
  ... num2 = 34;
  ... console.log(showOperationMessage(opSignal, num1, num2), module(num1, num2));
  ... } else {
  ... console.log(showErrorMessage(opSignal));
  ... }
