(function(window, document) {
	...
	*/
	...
	Caso contrário, mostre um alerta com a mensagem:
		- "Não enviado."
	*/
	$button.addEventListener('click', function verifyInputFields(event) {
	event.preventDefault();
	if ($inputUsername.value === '') 
	return alert('Preencha o campo nome de usuário!');
	if ($inputEmail.value === '') 
	...
	*/
	...
	var regexMail = /[\w.+]+?@\w+\.[a-z0-9]{2,}(\.[a-z0-9]{2})?/gi;
	var resultado = regexMail.test(email);
	return resultado;
	}	
})(window, document);
