(function() {
  ...
  */
  ...
  > var textMod = text.replace(/Manuel Marques de Sousa/, 'Rafael Estevan');
  > console.log(textMod);
  ...
  */
  ...
  > var textMod2 = text.replace(/brasileiro/, 'rolandense');
  > console.log(textoMod2);
  ...
  */
  ...
  > var textMod3 = text.replace(/[0-9]/g, '-');
  > console.log(textMod3);
  ...
  */
  ...
  > var textMod4 = text.replace(/[D-Hd-h]/g, '0');
  > console.log(textMod4);
  ...
  */
  ...
  > var textMod5 = text.replace(/[A]/gi, '4');
  > console.log(textMod5);
  ...
  */
  ...
  > var textMod6 = text.replace(/O Centauro de Luvas/g, function(string){
  ... return string.toUpperCase();
  ... });
  > console.log(textMod6);
  ...
  */
  ...
  > var regexDate = /([0-3][0-9]) de ([a-z]+) de ([0-2][0-9]{3})/g;
  > donsole.log(regexDate);
  ...
  */
  ...
  ... }
  > var textMod7 = text.replace (regexDate, replaceDate);
  > console.log(texMod7);
)}();
